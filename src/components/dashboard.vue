          ...
          <ul class="nav-menus">
            ...
            <li class="onhover-dropdown">
              ...
              <ul class="notification-dropdown onhover-show-div">
                ...
                <li>
                  <p>
                    <i class="fa fa-circle me-2 font-primary"></i>Delivery processing
...
import side from '../master_layout/side.vue'
import body_page from './body_page.vue'
...
export default {
  ...
  mounted() {
    setTimeout(() => {
        ...
        plugin2.setAttribute("src", "assets/js/scrollbar/simplebar.js");
        // plugin.setAttribute("src", "assets/js/scrollbar/custom.js");
        plugin.async = true;
        plugin2.async = true;
        document.head.appendChild(plugin2);
        // document.head.appendChild(plugin);
        // var myElement = document.getElementById('simple-bar');
        // const SimpleBar =  new SimpleBar(myElement, {
        //     autoHide: true
        // });
    }, 1000)
